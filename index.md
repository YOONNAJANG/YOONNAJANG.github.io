...
## **About**
Hello, I am an NLP researcher working at [Hanwha Aerospace](https://www.hanwhaaerospace.com/eng/index.do). Before, I was affiliated with the [CopeNLU](https://www.copenlu.com/) group at [University of Copenhagen](https://www.ku.dk/en) as a postdoc researcher, advised by Prof. [Isabelle Augenstein](https://isabelleaugenstein.github.io/index.html) and Prof. [Pepa Atanasova](https://apepa.github.io/). During my Ph.D, I was a student researcher in [NLP&AI Lab](http://nlp.korea.ac.kr/), advised by Prof. [Heuiseok Lim](https://scholar.google.com/citations?user=HMTkz7oAAAAJ&hl=en) and received the Ph.D. degree in the Department of Computer Science and Engineering at [Korea University](https://www.korea.edu/mbshome/mbs/en/index.do). I received the B.S degree from Korea University with majors in English Language and Literature / Language, Brain and Computer (LBNC). I have studied natural language processing, focusing on dialogue systems and commonsense reasoning. My research interests broadly lie in language models, and their factuality and explainability. Also, I've been focusing my research on Vision-Language-Action (VLA) models currently. 
